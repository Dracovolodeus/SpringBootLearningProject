...
public class JwtServiceImpl implements JwtService {
  ...
  public JwtPair generateJwtPair(Authentication authentication) {
    return new JwtPair(generateRefreshToken(authentication), generateAccessToken(authentication));
  }

  private String generateToken(
      Authentication authentication, long exp, Map<String, Object> claims) {
    UserDetails userDetails = (UserDetails) authentication.getPrincipal();
